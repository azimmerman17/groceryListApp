...
const AddUser = () => {
  const { setCurrentUser, currentUser } = useContext(CurrentUser)
	...
	async function handleSubmit(e) {
		...
		await fetch(`https://grocery-list-app-4y2gz122s-azimmerman17.vercel.app/user/`, {
			method: 'POST',
			headers: {
        ...
        ? (
          <Stack gap={2}>
            <div>
              ...
              <Button href='https://grocery-list-app-psi.vercel.app/foods/foodlist'>Add Food to Grocery List</Button> 
            </div>
